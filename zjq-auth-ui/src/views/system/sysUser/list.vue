        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="关 键 字">
              <el-input style="width: 95%" v-model="searchObj.keyword" placeholder="用户名/姓名"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
...
<script>
import {getPageList, removeById, save, getById, updateById, updateStatus} from '@/api/sysUser'
import {getRolesByUserId, assignRoles} from '@/api/sysRole'
...
export default {
  ...
  methods: {
    ...
    //添加
    save() {
      save(this.sysUser).then(response => {
    ...
    //更新
    update() {
      updateById(this.sysUser).then(response => {
